...
<html>
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <span class="hidden-xs"><?php echo $id_user; ?></span>
                                </a>
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            <a href="reportes/reportes.php?id_user=<?php echo $id_user; ?>">
                                <i class="fa fa-laptop"></i>
                                <span>Reportes</span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                ...
                <section class="content">
                    ...
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">Administrar Tipos de Encuestas</h3>
                        ...
                        <div class="box-body" id="content">
                            <div class="table-responsive text-justify text-primary" id="tablaTipoEncuesta">
                            </div>
                        ...
                        <div class="box-footer clearfix">       
                            <button class="btn btn-info btn-flat pull-left" id="tipo_encuesta" data-dismiss='modal' data-keyboard='true' data-toggle='modal' data-title='Tipo de Encuesta'  data-target='#tipo_encuesta_modal' href='modalTipoEncuesta.php?id_tipo_encuesta='>Nuevo Tipo de Encuesta</button>
                        </div>
                        <!-- /.box-footer -->
                    </div>
                    <!-- /.box -->
    ...
    <div class="modal fade" id="tipo_encuesta_modal" tabindex='-1' role="dialog" aria-labelledby="global-modal-title">
...
<script type="text/javascript">
    $(document).ready(function () {
        $.ajax({
            method: "POST",
            url: "funciones.php",
            data: {funcion: 'traerTipoEncuesta'}
        })
                .done(function (event) {
                    if (event.result == 'ok') {
                        $("#tablaTipoEncuesta").html(event.data);
                    } else {
                        $("#tablaTipoEncuesta").html('No se pudieron traer los tipos de encuestas');
                    }
                    //window.location.reload();
                });
    });

    function eliminarTipoEncuesta(id){
        $.ajax({
            method: "POST",
            url: "funciones.php",
            data: {funcion: 'eliminarTipoEncuesta',id_tipo_encuesta:id}
        })
                .done(function (event) {
                    if (event.result == 'ok') {
                        $.ajax({
    ...
    function eliminarEncuesta(id_tipo_encuesta) {
        $.ajax({
            ...
            url: "funciones.php",
            dataType: 'json',
            data: {funcion: 'eliminarEncuesta', id_empresa: id_tipo_encuesta}
        })
                .done(function (event) {
                    if (event.result == 'ok') {
                        $.ajax({
    ...
    function administrarRespuestas(idpregunta, id_tipo_encuesta) {
      //  alert( $("#idpregunta").val()+'*'+ id_tipo_encuesta   ); 
