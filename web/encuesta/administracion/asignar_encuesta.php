                ...
                <section class="content">
                    ...
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">Asignar Encuestas</h3>
...
<script type="text/javascript">
    ...
    function asignarTipoEncuesta(id_tipo_encuesta) {
        $.ajax({
            method: "POST",
            url: "funciones.php",
            dataType: 'json',
            data: {funcion: 'traerAsignaciones', id_tipo_encuesta: id_tipo_encuesta}
        })
                .done(function (event) {
                    if (event.result == 'ok') {
                        $("#asignaciones_" + id_tipo_encuesta).html(event.data);
                    } else {
                        alert('No se pudieron traer los usuarios');
                    }
                });
    }
    function borrarAsignacion(id_tipo_encuesta, id) {
        $.ajax({
            method: "POST",
            url: "funciones.php",
            dataType: 'json',
            data: {funcion: 'borrarAsignacion', id: id}
        })
                .done(function (event) {
                    if (event.result == 'ok') {
                        $.ajax({
    ...
    function ocultarAsignaciones(id_tipo_encuesta) {
        $("#asignaciones" + id_tipo_encuesta).html("");
    }
