...
//print(" T� IP es: $realip"); 
	   ...
	   if (
                (($uno == '192' && $dos == '168' && $tres == '0' && ($cuatro>=0 && $cuatro<=255)) && ($uno == '192' && $dos == '168' && $tres == '0' && $cuatro!=5)) 
              || 
                ($uno == '127' && $dos == '0' && $tres == '0' && $cuatro==='1') 
              || 
                ($uno == '192' && $dos == '168' && $tres == '1' && ($cuatro>=0 && $cuatro<=255))
              ||
                ($uno == '192' && $dos == '168' && $tres == '2' && ($cuatro>=0 && $cuatro<=255))
              )
               return "192.168.1.242";
	   else
	       return "181.168.99.14";
	}
