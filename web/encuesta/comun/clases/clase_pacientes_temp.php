	...
	class clase_pacientes_temp 
	{
		...
		function arreglo_paciente()
		{
			return $this->arreglo_paciente;
                ...
                function ocupacion_asigna($campo)
                {
                    $this->ocupacion=$campo;
                }
		...
		function guardar()
		{
			$bd = new baseDatos();
			$bd->Conectarse();
                        if ($bd->select("INSERT INTO pacientes_temp(nombre,documento,provincia,localidad,ocupacion,telefono_celular,mail,id_tipo_encuesta) VALUES('".$this->nombre."','".$this->documento."','".$this->provincia."','".$this->localidad."','".$this->ocupacion."','".$this->telefono_celular."','".$this->mail."',".$this->id_tipo_encuesta.")"))
                            return 1;
			else 
			    return 0;
