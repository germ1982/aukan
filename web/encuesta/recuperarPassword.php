    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            ...
            <div class="login-box-body">
                ...
                <label>Complete y envíe el siguiente formulario para recuperar su contraseña</label>                          
                    ...
                    <div class="row">
                        <!-- /.col -->
                        <div class="col-xs-12">
                            <button type="submit" class="btn btn-primary" id="recuperar_pass">Recuperar Contraseña</button>
                        </div>
                        <!-- /.col -->
                    </div>
                <!-- /.social-auth-links -->
            ...
            $(function () {
                $('#recuperar_pass').click(function(){
                    ...
                    if (nombre === "" || dni === "" || fecha_nacimiento === ""){
                        alert('Debe completar todos los campos para recuperar su contraseña');
                        ...
                        $.ajax({
                            ...
                            dataType: 'json',
                            data: {web:'1',nombre_apellido: nombre,dni:dni,fecha_nacimiento:fecha_nacimiento,generar:0}//,fecha_desde:fecha_desde,fecha_hasta:fecha_hasta}
                        })
                        .done(function (event) {
                            if (event.result == 'ok'){
                                ...
                                alert('No se ha podido comprobar su identidad o no posee un mail registrado,\npor favor diríjase a Traumatología del Comahue');
                                window.location.href = 'login.php'; 
                            } 
                        });
                    }
