                    ...
                    <section class="content">
                        ...
                        <div class="box box-info">
                            ...
                            <div class="box-body" id="content">    
                                <div class="text-right"><button class="btn btn-primary" id="nuevaRespuesta">Nueva Respuesta</button></div>
        ...
        $(document).ready(function () {
            ...
            .done(function (event) {
                $('#example').DataTable({
                    ...
                    ajax: "administracion/funciones.php?funcion=traerMisEncuestasBusqueda&id_user=<?php echo $id_user; ?>&id_tipo_encuesta=<?php echo $id_tipo_encuesta; ?>",
