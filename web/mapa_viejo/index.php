...
<div class="wrapper">
    <?php 
        ...
        include 'includes/menu_capas.php';
    ?>
...
<?php //include 'includes/menu_capas_1.php'; ?>
    ...
    function cambiar_todo(check){
        $("input[type=checkbox]").each(function(){
            ...
            if ($(this).val()!=='todos'){
                ...
                cambiar_icono(null,id, null,val);
            }
        });
    }
...
<script>
    ...
    function load() {
      ...
      downloadUrl("cargar_puntos.php", function(data) {
        ...
        for (var i = 0; i < markers.length; i++) {
          ...
          var sitio = markers[i].getAttribute("sitio");
          ...
          var html = '<font color="black"><b>'+ nombre + 
                        '</b><br>'+ direccion + 
                        '</b><br>'+ descripcion + 
                        '<br/><br/></font>' + '<a href="'+sitio+'" target="_blank">Más Info!</a>';
          var marker = new google.maps.Marker({
              map: map,
              //animation: google.maps.Animation.DROP,
              position: point
          });
		  icon='iconos/'+markers[i].getAttribute("icon");+'.png';
          /*switch (tipo) {
                case 'Deporte':
                    icon='iconos/deporte.png';
                    break;
                case 'Discapacidad':
                    icon='iconos/discapacidad.png';
                    break;
                case 'Educación':
                    icon='iconos/educacion.png';
                    break;
                case 'Seguridad Vial':
                    icon='iconos/seguridad_vial.png';
                    break;
                case 'Consumo Problemático':
                    icon='iconos/consumo_problematico.png';
                    break;
                case 'Género':
                    icon='iconos/genero.png';
                    break;
                case 'Adultos Mayores':
                    icon='iconos/adultos_mayores.png';
                    break;
                case 'Niñez y Adolescencia':
                    icon='iconos/ninez_adolescencia.png';
                    break;
                case 'Cultura':
                    icon='iconos/cultura.png';
                    break;
                case 'Economia Social':
                    icon='iconos/economia_social.png';
                    break;
                case 'Producción':
                    icon='iconos/produccion.png';
                    break;
                case 'Salud':
                    icon='iconos/salud.png';
                    break;
                case 'Religión':
                    icon='iconos/religion.png';
                    break;
                default:
                    icon='';
                    break;
