                ...
                <div class="col-md-12 col-sm-12">
                    <div class="panel-group" id="accordion">
                        <div class="panel panel-default">
                          <div class="panel-heading">
                            <h4 class="panel-title">
                                <a data-toggle="collapse" data-parent="#accordion" href="#collapse1"><i class="fa fa-object-ungroup"></i>
                              &nbsp;Seleccione la Capa...</a>
                            </h4>
                          </div>
                          <div id="collapse1" class="panel-collapse collapse">
                            <div class="panel-body"><section id="submit" class="submit">
                        <section id="select-package">
                            <div class="table-responsive submit-pricing">
                                <table class="table">
                                    ...
                                    <tr>
                                            <td>Capacitaciones y Charlas</td>
                                            <td class="available"><i class="fa fa-check"></i></td>
                                            <td class="not-available"><i class="fa fa-times"></i></td>	
                                            <td class="not-available"><i class="fa fa-times"></i></td>
                                    </tr>
                                    <tr>
                                            <td>Talleres y Foros</td>
                                            <td class="available"><i class="fa fa-check"></i></td>
                                            <td class="not-available"><i class="fa fa-times"></i></td>	
                                            <td class="not-available"><i class="fa fa-times"></i></td>
                                    </tr>
                                    <tr>
                                            <td>Actos y Lanzamientos</td>
                                            <td class="available"><i class="fa fa-check"></i></td>
                                            <td class="not-available"><i class="fa fa-times"></i></td>	
                                            <td class="not-available"><i class="fa fa-times"></i></td>
                                    </tr>
                                    <tr>
                                            <td>Encuentros y Visitas</td>
                                            <td class="available"><i class="fa fa-check"></i></td>
                                            <td class="not-available"><i class="fa fa-times"></i></td>	
                                            <td class="not-available"><i class="fa fa-times"></i></td>
                                    </tr>
                                    ...
                                    <tr class="buttons">
                                        <td></td>
                                        <td data-package="free"><button type="button" class="btn btn-default small">Select</button></td>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                            <h4 class="panel-title">
                              <a data-toggle="collapse" data-parent="#accordion" href="#collapse2"><i class="fa fa-edit"></i>
                              &nbsp;&nbsp;Ingrese los datos...</a>
                            </h4>
                          </div>
                        ...
                        <div class="panel panel-default">
                          <div class="panel-heading">
                            <h4 class="panel-title">
                              <a data-toggle="collapse" data-parent="#accordion" href="#collapse3"><i class="fa fa-globe"></i>
                              &nbsp;&nbsp;&nbsp;Seleccione la Ubicación</a>
                            </h4>
                          </div>
