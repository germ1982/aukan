<?php
    ...
    $sql = "SELECT Abreviatura,Icono, Descripcion,idCapa, case when idCapaPadre is null then idCapa else idCapaPadre end elpadre
            FROM CDD_GIS_Capa
            WHERE idCapaPadre is null and Tipo=1 and Activo='True' and idCapa between 13 and 27;";
    $contenido= 
        '<div align="center" class="col-md-1 col-sm-1" style="background-color: rgba(255,255,255,0.7);padding-bottom: 0.5em;padding-top: 0.5em;padding: 0.5em 0.5em;position: fixed;top: 0px;left: 0px;cursor: pointer;">Menu<br><form id="capas">';
