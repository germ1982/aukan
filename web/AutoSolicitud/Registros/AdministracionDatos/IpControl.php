...
function GenerarConsulta()
	{
		...
		$Consulta = "Select Id, Ip, Areas.Area, Usuarios.Usuario, Observacion, IdUsuarioEdicion, FechaEdicion from IpControl inner join Areas on IpControl.IdArea = Areas.IdArea inner join Usuarios on IpControl.IdUsuario = Usuarios.IdUsuario Where Ip like '$SR%'";
...
<script type="text/javascript">	
	...
	function MostrarSubred(clicked_value)
		{
			//alert(clicked_value);
			location.href = "IpControl.php?VarSubred="+clicked_value;
		}
	...
	function verBoton(clicked_id)
		{
			var aux = clicked_id;
			//alert(aux);
			location.href ="EditarIp.php?VarIp="+aux;
		}
