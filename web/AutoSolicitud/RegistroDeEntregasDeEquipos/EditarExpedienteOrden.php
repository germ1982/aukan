...
<body onload="SetControles()">
	...
	<h1>Modificar Numero de la Orden</h1>
	<hr>
	<p id="TextoHtml"></p> 
	<input type='text' id="InputNumeroOrden" style="width:400px;" placeholder="Numero" required/>
	<hr>
...
<script type="text/javascript">
	...
	function SetControles()
		{
			...
			var aux = document.getElementById('VarOrden').value;
			document.getElementById("InputNumeroOrden").value = aux;
		}

	function ValidarDatos()
		{
			
			var aux = document.getElementById("InputNumeroOrden").value;
	   		var DatoOriginal = document.getElementById("VarOrden").value;
	   		if (!(DatoOriginal==aux))
	   			{
	...
	function GuardarExpediente()
		{	
			...
			var Orden = document.getElementById('InputNumeroOrden').value;
	...
	function EjecutarCancelar()
	{
		...
		var aux = 'MenuOpcionesEdicion.php?VarIdOrdenDetalle=' + IdElemento;
		location.href=aux;
	}
</script>
...
function PrepararFormulario()
	{
			...
			$Texto = "Cambiar numero de la orden: $Orden: ";
