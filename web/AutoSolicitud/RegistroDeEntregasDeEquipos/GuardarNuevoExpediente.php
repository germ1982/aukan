...
$Expediente = $data->InputVarExpediente;
$IdUsuarioSolicitante = $data->InputVarIdUsuarioSolicitante;
$IdArea = $data->InputVarIdArea;
...
echo "<br>Id usuario: $IdUsuarioSolicitante<br>";
$dbh = new BaseDatos();
$dbh->Iniciar();


$consulta = "INSERT INTO Expedientes(IdArea, IdUsuario, Expediente) VALUES($IdArea, $IdUsuarioSolicitante, '$Expediente')";
echo "Insert del Expediente: $consulta";
$dbh->Ejecutar($consulta);


$IdExpediente = getId('Expedientes', 'IdExpediente', 'Expediente', $Expediente);
echo "<br>IdExpediente: $IdExpediente<br>";
