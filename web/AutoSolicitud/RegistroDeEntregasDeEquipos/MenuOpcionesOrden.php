		...
		switch(Operacion) 
			{
			    ...
			    case 6:
			        ...
			        break;
			    case 7:
			        aux = 'EditarFechaIngresoOrden.php?VarIdOrdenDetalle=' + IdOrdenDetalle;
			        break;
			    case 8:
			        aux = 'EditarProvedorDeOrden.php?VarIdOrdenDetalle=' + IdOrdenDetalle;
			        break;
			    case 9:
			        aux = 'MenuEditarInsumosDeOrden.php?VarIdOrden=' + IdOrdenDetalle;
			        break;
			    default:
			        alert("Falta algo");
			}
...
function MostrarMenuOrden($IdOrdenDetalle, $Orden)
	{
		echo"<div id='Caja' style='width: 400px; text-align: center;'>";
			echo "<table id='TablaRegistros' style='width: 400px; text-align: center;'>";
				...
				echo "<tr>"; 
				$IdOrden = getId('OrdenDetalle', 'IdOrden', 'IdOrdenDetalle', $IdOrdenDetalle);
				echo "<th><button type='submit' name='ModificarInsumos' onclick='EjecutarOperacion(9,$IdOrden);'>Editar Insumos</button></th>";
				echo "</tr>";

				echo "<tr>"; 
				echo "<th><button type='submit' name='ModificarNumeroOrden' onclick='EjecutarOperacion(6,$IdOrdenDetalle);'>Modificar Numero</button></th>";
				echo "</tr>";

				echo "<tr>"; 
				echo "<th><button type='submit' name='ModificarFechaIngreso' onclick='EjecutarOperacion(7,$IdOrdenDetalle);'>Modificar Fecha De Ingreso</button></th>";
				echo "</tr>";

				echo "<tr>"; 
				echo "<th><button type='submit' name='ModificarPRovedor' onclick='EjecutarOperacion(8,$IdOrdenDetalle);'>Modificar Provedor</button></th>";
				echo "</tr>";
