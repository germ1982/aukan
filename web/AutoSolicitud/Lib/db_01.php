...
class BaseDatos {
	...
	var $NumTupla;
	var $CantTupla;
	var $connectionInfo = array("Database"=>"recepcion", "UID"=>"usuariobd", "PWD"=>"clienteapp");

  function Iniciar(){
		//echo "Entra a la funcion Iniciar y se prepara para ejecutar mssql_connect() con: <br>Hostname: $this->HOSTNAME<br>Usuario: $this->USUARIO<br>Clave: $this->CLAVE";
       $conexion = mssql_connect($this->HOSTNAME,$this->USUARIO,$this->CLAVE);
       //echo "<br>Realizo el mssql_connect() correctamente";
       if ($conexion){
	       //echo "se conecto";
