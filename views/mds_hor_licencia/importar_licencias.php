    ...
    <div class="col-md-12 col-lg-12 col-xl-12">
        <section class="panel">
            <div class="panel-body">                
                <iframe id="iframe_importar_excell" width="100%" height="600" 
                src="AutoSolicitud/Exell/index.php?idusuario=<?= Yii::$app->user->identity->idusuario; ?>">
                </iframe>
            </div>
        </section>
    </div>
