...
<div style="border: ridge 1px; padding: 8px; border-color:#D8D8D8;">  
    ...
    <div class="row">                
        <div class="col-md-6">
            ...
            ?>
             <?php
                        ...
                        ->one();                                                                   
                ?>  
                <?= $form->field($model, 'id_variable_dim')
        ...
        <div class="col-md-6">              
            <?= $form->field($model, 'id_iddimension_var')->widget(Select2::classname(), [
    ...
    <div class="row">   
        <div class="col-md-3" >
            ...
            <?php
                //$model->id_variable_dim= $model->  idvariable; 
               
            ?>


            <?= $form->field($model, 'idvariable')->hiddenInput(['id'=>'idvariable'])->label(false); ?>
            <?= $form->field($model, 'iddimension')->hiddenInput(['id'=>'iddimension'])->label(false); ?>
    ...
    <div class="row">   
            ...
            <div class="row">         
                ...
                <div class="col-md-5" style="display:<?php  if($model->mapear==0){echo "none";} else {echo "block";}   ?>" id="div_tipomapa">   
...
$script = <<<  JS
    ...
    function traer_plantilla(primera_vez = false) {
        ...
        const id_dimension=$("#iddimension").val();
        origen=$("#origen").val();
        idvardimension=$("#idvardimension").val();

                $.post("index.php?r=sds_com_configuracion/cmb_idvariable_update&id_plantilla="+id_plantilla+"&idvariable="+idvariable, function(data) {                                                           
                ...
                {  
                    $.post("index.php?r=sds_com_configuracion/cmb_iddimension_update&idvariable="+idvariable+"&iddimension="+id_dimension, function(data) {                                 
                                
                                $("select#cmb_dimension").html(data);
                    });
                }                            
                $.post("index.php?r=mds_r_plantilla/obtener_capa_plantilla&idvardim="+idvardimension+"&id_plantilla="+id_plantilla, function(data) 
                {      
                        data = $.parseJSON(data);                                                
                        $("#origen").val(data[0]);  
                        $("#id_giscapa").val(data[1]);                                           
                });
    }
