    ...
    <div class="col-md-12 col-lg-12 col-xl-12">
        <section class="panel">
            <div class="panel-body">
                ...
                <?php $form = ActiveForm::begin(['id' => 'formOficio', 'action' => ['mds_acomp_asistencia/dashboard'], 'options' => ['enctype' => 'multipart/form-data', 'form-oficio']]); ?>
                ...
                <div class="row ">
                    <div class="col-md-6 col-sm-12 placeholder">
                        ...
                        <strong style="font-size: 40px"><span><?= count($totalRegistros); ?></span></strong>
                    </div>
                </div>
