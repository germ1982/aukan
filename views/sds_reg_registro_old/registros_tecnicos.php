...
$tipo = $_GET['idtipo'];
$soloincidencias = $_GET['soloincidencias'];
?>
    ...
    <div class="col-md-12 col-lg-12 col-xl-12">
        <section class="panel">
            <div class="panel-body">
                <iframe id="iframe_registros" width="100%" height="600" src="AutoSolicitud/Registros/RegistrosPendientes.php?VarTipo=<?= $tipo ?>&idusuario=<?= Yii::$app->user->identity->idusuario; ?>&VarSoloIncidencias=<?= $soloincidencias ?>">
                </iframe>
            </div>
        </section>
    </div>
