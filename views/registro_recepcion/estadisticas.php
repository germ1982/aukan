...
?>
<div style="padding: 25px; margin-top: -70px">
    <h2>Estadísticas de Derivación</h2>
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <?= DatePicker::widget([
                        ...
                        //'value' => $fecha_inicio, // Acá le pasás el valor para que aparezca
                ...
                <div class="col-md-3">
                    ...
                    <?= DatePicker::widget([
                        ...
                        //'value' => $fecha_final, // Acá le pasás el valor para que aparezca
                        'options' => ['placeholder' => 'Seleccionar fecha...'],
                        'pluginOptions' => [
                            'autoclose' => true,
                            'format' => 'dd/mm/yyyy',
