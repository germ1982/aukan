...
$urlIndex = "index.php?r=sds_800_llamada";
$urlIndexIntervencionViolencia = "index.php?r=sds_vio_intervencion";
...
<div class="row">
    <div class="col-md-12 col-lg-12 col-xl-12">
        <section class="panel">
            <div class="panel-body">
                ...
                <?php $form = ActiveForm::begin(['id' => 'formLlamada', 'action' => ['sds_800_llamada/dashboard'], 'options' => ['enctype' => 'multipart/form-data', 'form-llamada']]); ?>
                ...
                <div class="row ">
                    <div class="col-md-6 col-sm-12 placeholder">
                        <h4 class="subtitulo-dashboard"><b>TOTAL GUARDIAS INTEGRADAS:</b></h4>
                        <strong style="font-size: 40px"><span><?= count($totalGuardias); ?></span></strong>
                    </div>
                </div>
    ...
    <div class="row ">
        <div class="col-md-6 col-sm-12 placeholder">
            <h4 class="subtitulo-dashboard"><b>TOTAL INTERVENCIONES VIOLENCIA:</b></h4>
            <a href="<?= $urlIndexIntervencionViolencia ?><?= ($fechaInicio) ? "&fechaInicio=$fechaInicio" : '' ?><?= ($fechaFin) ? "&fechaFin=$fechaFin" : '' ?>" target="_blank"><strong style="font-size: 40px"><span><?= count($totalVioIntervencion); ?></span></strong></a>
        </div>
    </div>
    </div>
    </section>
