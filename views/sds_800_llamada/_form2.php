        ...
        <div class="col-md-12 col-lg-12 col-xl-12">
            <section class="panel">
                <div class="panel-body">
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion_llamante" href="#llamante">
                                        Datos del Llamante o Solicitante de Situación ACAAAA
                                    </a>
                                </h4>
                            </div>
                        ...
                        <div class="panel panel-accordion">
                            ...
                            <div id="detalle" class="accordion-body collapse in">
                                <div class="panel-body" id="detalle_content">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <?= $form->field($model, 'detalle')->textarea(['rows' => 6, "disabled" => "true"])->label("Descripción") ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <?= $form
                                                ...
                                                ->dropdownList(
                                                    ArrayHelper::map(
                                                        Sds_com_configuracion::getConfiguracionesActivas(
                                                            Sds_com_configuracion_tipo::TIPO_SITUACION_TIPO,
                                                            true
                                                        ),
                                                        'idconfiguracion',
                                                        'descripcion'
                                        ...
                                        <div class="col-md-4 required">
                                            <?= $form->field($model, 'idderivacion')->dropdownList(
                                                ArrayHelper::map(
                                                    Sds_800_derivacion::find()->where(["activo" => 1])->orderBy(['descripcion' => SORT_ASC])->all(),
                                                    'idderivacion',
                                                    'descripcion'
                                                ),
                                                [
                    ...
                    <?php echo Collapse::widget([]); ?>
                    <div class="panel-group" id="accordion_aspsocial" style="display:<?= $model->estado ==
                    ...
                    <?php echo Collapse::widget([]); ?>
                    <div class="panel-group" id="accordion_habitacional" style="display:<?= $model->estado ==
                                                                                            Sds_800_llamada::ESTADO_CERRADA ||
                                                                                            $model->estado == Sds_800_llamada::ESTADO_DESPEJADA
                                                                                            ||  $obj_atencion != null
                                                                                            ? 'block'
                    ...
                    <?php echo Collapse::widget([]); ?>
                    <div class="panel-group" id="accordion_salud" style="display:<?= $model->estado ==
                                                                                        Sds_800_llamada::ESTADO_CERRADA ||
                                                                                        $model->estado == Sds_800_llamada::ESTADO_DESPEJADA
                                                                                        ||  $obj_atencion != null
                                                                                        ? 'block'
                    ...
                    <?php echo Collapse::widget([]); ?>
                    <div class="panel-group" id="accordion_aspeconom" style="display:<?= $model->estado ==
                                                                                            Sds_800_llamada::ESTADO_CERRADA ||
                                                                                            $model->estado == Sds_800_llamada::ESTADO_DESPEJADA
                                                                                            ||  $obj_atencion != null
                                                                                            ? 'block'
                        ...
                        <?php if (!Yii::$app->request->isAjax) { ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">
                                    <?= Html::submitButton($model->isNewRecord ? 'Guardar' : 'Editar', ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-success']) ?>
                                </div>
                            </div>
...
<script>
    ...
    function habilitar_controles() {
        ...
        $("#sds_800_llamada-detalle").prop("disabled", false);
        ...
        if (estado != 0) {
            ...
            $("#sds_800_llamada-detalle").prop("disabled", true);
