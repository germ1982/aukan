    ...
    <div class="col-md-12 col-lg-12 col-xl-12">
        <section class="panel">
            <div class="panel-body">
                ...
                <?php $form = ActiveForm::begin(['id' => 'formCertificacion', 'action' => ['mds_certificacion/dashboard'], 'options' => ['enctype' => 'multipart/form-data', 'form-certificacion']]); ?>
                ...
                <div class="row ">
                    <div class="col-md-6 col-sm-12 placeholder">
                        <h4 class="subtitulo-dashboard"><b>TOTAL CERTIFICACIONES:</b></h4>
                        <?php if ($urlArea) { ?>
                            <a href="<?= $urlIndex ?><?= ($fechaInicio) ? "&fechaInicio=$fechaInicio" : '' ?><?= ($fechaFin) ? "&fechaFin=$fechaFin" : '' ?>" target="_blank"><strong style="font-size: 40px"><span><?= count($totalCertificaciones); ?></span></strong></a>
                        <?php } else { ?>
                            <strong style="font-size: 40px"><span><?= count($totalCertificaciones); ?></span></strong>
                        <?php } ?>
                    </div>
                </div>
        ...
        <?php endif;
            ...
            <?php if (!$existeTitulo) : ?>
                ...
                <div class="col-md-6 col-sm-12 placeholder">
                    ...
                    <?php } else { ?>
                        <strong style="font-size: 40px"><span><?= $indicador['cantidadRegistros']; ?></span></strong>
                    <?php } ?>
                </div>
            <?php endif;
