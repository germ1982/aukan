...
/* @var $searchModel app\models\Sds_reg_fotocopiadoraSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Fotocopiadoras';
...
<div class="row">
    <div class="col-md-12 col-lg-12 col-xl-12" style="background-color: #fff; border-radius: 5px;">
        <div class="sds-reg-fotocopiadora-index">
                    ...
                    'toolbar' => [
                        [
                            ...
                            Html::a(
                                ...
                                ['create'],
                                ['role' => 'modal-remote', 'title' => 'Añadir Fotocopiadora', 'class' => 'btn btn-default']
                            ) .
                                Html::a(
