...
<div class="stock-deposito-egreso-detalle-form">

    <?php $form = ActiveForm::begin(); ?>
    <div class="row">
        <div class="col-md-10">
            <?= SiteController::actionGet_input_select2($form, $model, 'idarticulo', 'cmb_articulos', Articulo::get_articulos_rubro_disponible(116), 'idarticulo', 'descripcion', 'Articulo',null,null,'get_disponible_articulo();') ?>
        </div>
        <div class="col-md-2">
...
<script>
    ...
    function get_disponible_articulo(){
        ...
        $.post("index.php?r=stock_deposito_egreso_detalle/disponible_articulo&idarticulo=" + id_articulo, function(data) {
            data = $.parseJSON(data);
