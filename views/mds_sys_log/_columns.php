...
return [
    [
        ...
        'detail' => function ($model, $key, $index, $column) {
            return $model->id != null ? Yii::$app->controller->renderPartial('_expand', ['model' => $model]) : "";
        },
    ...
    [
        ...
        'filterType' => GridView::FILTER_SELECT2,
        'filter' =>  ArrayHelper::map(
            Mds_sys_log::findBySql("select if(modulo like '%mds_cor_intervencion_usuario%','mds_cor_intervencion_usuario',SUBSTRING_INDEX(modulo,'/',1)) modulo
            from mds_sys_log
            group by modulo order by modulo")->all(),
            'modulo',
            'modulo'
        ),
        'filterWidgetOptions' => [
        ...
        'filterInputOptions' => ['placeholder' => 'Seleccionar Módulo...'],
        'format' => 'raw',
        'width' => '12%'
    ],
    [
