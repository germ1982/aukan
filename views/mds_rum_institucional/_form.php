                            ...
                            echo $form->field($model, 'archivo_imagen', ['enableClientValidation' => true, 'enableAjaxValidation' => false])
                                ->widget(FileInput::classname(), [
                                    ...
                                    'pluginOptions' => [
                                        ...
                                        'uploadUrl' => Url::to(['/mds_rum_institucional/update']),
                                        'maxFileSize' => 1000,
                                        /* 'initialPreview'=>[
                            ...
                            echo $form->field($model, 'archivo_imagen', ['enableClientValidation' => true, 'enableAjaxValidation' => false])
                                ->widget(FileInput::classname(), [
                                    ...
                                    'pluginOptions' => [
                                        ...
                                        'showCancel'=> false,
                                        'mainClass' => 'input-group-sm',
                                        'uploadUrl' => Url::to(['/mds_rum_institucional']),
                                        'maxFileSize' => 1000,
                                        'previewFileType' => 'image',
                                        'initialPreview' => [
                                            //Html::img($model->imagen, ['class' => 'file-preview-image', 'style' => 'width:100%']),
                                            Html::img(Url::base()."/uploads/institucional/".$model->imagen, ['class' => 'file-preview-image', 'style' => 'width:100%']),
