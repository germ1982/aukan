                ...
                <div class="panel-body">
                    ...
                    <div style="border: ridge 1px; padding: 8px; border-color:#D8D8D8;">
                        ...
                        <div class="row">
                            ...
                            echo '
                    <div class="col-md-3">';
                            $model->dni_search = $un_com_persona->documento;
                            echo $form
                ...
                <div class="row">
                    ...
                    <div class="col-md-4"> ';
                            ...
                            /*if ($model->fecha_nac != null) {
                                $model->fecha_nac = date('d/m/Y', strtotime(str_replace('/', '-', $model->fecha_nac)));
                            }*/
                            //echo $form->field($model, 'fecha_nac')->textInput(['id'=>'fecha_nac','maxlength' => true,"readOnly"=>false]);
                            echo $form
                            ...
                            foreach ($tipos_asistencias as $tipo_asist) {
                                ...
                                if (
                                    ...
                                    if ($tipo_asist->idconfiguracion == 2187) {
                                        $la_asistencia = Mds_inv_asistencia::find()
                                            ->where([
                                                'idpersona' =>
                                                    $model->idpersona,
                                                'idconfiguracion' =>
                                            ...
                                            ->one();
                                        if ($la_asistencia != null) {
                                            if (
                                                $la_asistencia->descripcion ==
                                                null
                                            ) {
                                                $model->obs1 = null;
                                            } else {
...
<?php
    $entrega_persona = Mds_inv_persona::findBySql("select * from mds_inv_persona r inner join sds_com_persona p on r.idpersona  = p.idpersona where p.documento = $un_com_persona->documento;")->one();
    if ($entrega_persona != null) {   //si         
...
?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4" id="div_cosecha_plantines" style="display: <?= $model->recibe_plantines == 2 ? 'block' : 'none'   ?>">
                                    <?= $form
                    ...
                    <div class="row" id="save_exitoso" style="display:none;">
                        ...
                        <div class="alert alert-success alert-dismissable" id="save_ok">
                            ...
                            <h4><i class="icon fa fa-check"></i> Cambios exitosamente guardados. Haga click en <b>"Cerrar"</b> y registre los plantines.<i class="fas fa-seedling"> </i> <i class="fas fa-heart"></i> <i class="fas fa-seedling"></i></h4>
                        </div>
                    </div>
                    <br>
...
<script>
    ...
    function guardar_inscripcion() {
        ...
        var cad_error = '';
        if (dni_search.trim() == '') {
            //error=true;cad_error="Error: DNI no debe estar vacío. Campo obligatorio.";
            error = true;
            $("#labeldni").show();
        } else {
            if (nombre.trim() == '') {
        ...
        if (error == false) {
            ...
            $.post("index.php?r=mds_inv_persona/updatepersona&whatsapp=" + whatsapp + "&arr_seg2=" + arr_seg2 + "&arr_seg=" + arr_seg + "&idpersona=" + idpersona + "&apellido=" + apellido + "&nombre=" + nombre + "&fecha_nac=" + fecha_nac + "&genero=" + genero + "&nacionalidad=" + nacionalidad + "&dni=" + dni_search + "&grupo_familiar=" + grupo_familiar +
