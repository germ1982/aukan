...
function campoCompactoClaro($titulo, $contenido)
{
    ...
    echo "<div class='tech-linea-horizontal'>
...
function campoEstadoTech($titulo, $activo, $textoActivo = 'ACTIVO', $textoInactivo = 'INACTIVO')
{
    ...
    echo "<div class='tech-linea-horizontal tech-status-line'>
            <span class='tech-label-horizontal'>$tituloUpper:</span>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="tech-field-wrapper">
                <div class="tech-title"><strong>EDIFICIO:</strong> <span style="color: #4a6984;"><?= strtoupper($nombreEdificio) ?></span></div>
