...
$this->title = "Mis respuestas Requerimiento #{$oficio->idlegalesoficio}";
...
<div class="row">
    <div class="col-md-12 col-lg-12 col-xl-12">
        <section class="panel">
            <div class="panel-body">
                <h3>Mis respuestas al requerimiento </h3>
                <br />
                ...
                foreach ($respuestas as $index => $respuesta) { ?>
                    <?php if ($respuesta) {
                        ...
                        if (!empty($respuesta_supervisorAdjuntos)) {
                            $htmlAdjuntosSupervisor = "<br /><label>Archivos adjuntos por supervisor/a:</label><ul style='list-style: none'>";
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body" style="word-break: break-all;">
                            ...
                            <?php if ($respuesta->ultimoEstado->estado == $idEstadoObservada) { ?>
                                ...
                                <?php if ($respuesta->derivacion && !$respuesta['idrespuestacorreccion']) : ?>
                                    <div class="card-footer">
                    ...
                    <?php if ($index !== count($respuestas) - 1) : ?>
