...
$urlIndex = "index.php?r=sds_ris_risneu";
    ...
    <div class="col-md-12 col-lg-12 col-xl-12">
        <section class="panel">
            <div class="panel-body">
                ...
                <?php $form = ActiveForm::begin(['id' => 'formRisneu', 'action' => ['sds_ris_risneu/dashboard'], 'options' => ['enctype' => 'multipart/form-data', 'form-risneu']]); ?>
                ...
                <div class="row ">
                    <div class="col-md-6 col-sm-12 placeholder">
                        <h4 class="subtitulo-dashboard"><b>TOTAL RISNeu:</b></h4>
                        <a href="<?= $urlIndex ?><?= ($fechaInicio) ? "&fechaInicio=$fechaInicio" : '' ?><?= ($fechaFin) ? "&fechaFin=$fechaFin" : '' ?>" target="_blank"><strong style="font-size: 40px"><span><?= count($totalRisneu); ?></span></strong></a>
                    </div>
                </div>
