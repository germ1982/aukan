...
/* @var $searchModel app\models\Mds_legales_caratulaSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Carátulas';
    ...
    <div class="col-md-12 col-lg-12 col-xl-12">
        <section class="panel">
            <div class="panel-body">
                ...
                <div class="mds-legales-caratula-index table-responsive">
                        ...
                        <?= GridView::widget([
                            ...
                            'toolbar' => [
                                ['content' => Html::a(
                                    ...
                                    ['create'],
                                    [
                                        'data-pjax' => 0, 'role' => 'post', 'title' => 'Nueva carátula',
