...
.file-drop-zone {
    ...
    display: flex;
    flex-wrap: wrap;
    justify-content: flex-start; /* Cambia esto si prefieres otro tipo de alineación */
    align-items: flex-start; /* Cambia esto si prefieres otro tipo de alineación */
}
.file-preview-frame {
...
.file-preview-image {
    ...
    transition: transform 0.3s ease; /* Animación para suavizar el cambio de tamaño */
}
.krajee-default {
