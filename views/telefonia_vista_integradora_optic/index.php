...
/* @var $searchModel app\models\Sds_vio_intervencionSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Telefonia Integracion de datos OPTIC';
                        ...
                        <?= GridView::widget([
                            ...
                            'toolbar' => [
                                ...
                                /*  Html::a(
                                    ...
                                    ['create'],
                                    ['role' => 'modal-remote', 'title' => 'Nueva intervencion', 'class' => 'btn btn-default']
                                ) . */
                                Html::a(
