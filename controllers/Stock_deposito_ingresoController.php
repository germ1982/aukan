...
use app\models\StockDepositoIngresoSearch;
...
class Stock_deposito_ingresoController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new StockDepositoIngresoSearch();
    ...
    {
        $request = Yii::$app->request;
        $model = new StockDepositoIngreso();
            ...
            if ($request->isGet) {
                ...
                if ($guardado && $model->save()) {
                    ...
                    foreach ($detallesArray as $detalle) {
                            $detalleModel = new StockDepositoIngresoDetalle();
        ...
        if ($request->isAjax) {
            ...
            if ($request->isGet) {
                ...
                if ($guardado && $model->save()) {
                    ...
                    $detallesExistentes = StockDepositoIngresoDetalle::findAll(['idingreso' => $model->idingreso]);
                    ...
                    foreach ($detallesArray as $detalle) {
                        ...
                        $detalleExistente = StockDepositoIngresoDetalle::findOne([
    ...
    {
        if (($model = StockDepositoIngreso::findOne($id)) !== null) {
            return $model;
        } else {
