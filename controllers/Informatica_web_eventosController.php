...
class Informatica_web_eventosController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new InformaticaWebEventos",
                ...
                return [
                    ...
                    'title'=> "Create new InformaticaWebEventos",
                    'content'=>'<span class="text-success">Create InformaticaWebEventos success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Updates an existing InformaticaWebEventos model.
     * For ajax request will return json object
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update InformaticaWebEventos #".$id,
    ...
    /**
     * Delete an existing InformaticaWebEventos model.
     * For ajax request will return json object
