...
class LocalidadesController extends Controller
{
            ...
            */
            ...
            if ($request->isGet) {
                ...
                return [
                    ...
                    'title' => "Create new Localidades",
                    'content' => '<span class="text-success">Create Localidades success</span>',
                    'footer' => Html::button('Close', ['class' => 'btn btn-default pull-left', 'data-dismiss' => "modal"]) .
    ...
    /**
     * Delete an existing Localidades model.
     * For ajax request will return json object
    ...
    /**
     * Delete multiple existing Localidades model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    public function actionLocalidades($id_provincia)
    {
        $localidades = Localidades::find()
            ->where(['id_provincia' => $id_provincia])->orderBy('localidad ASC')
            ->all();

        // Formato para Select2: id y texto
        $localidadList = ArrayHelper::map($localidades, 'id', 'localidad');

        // Devolver el resultado como JSON
        return json_encode($localidadList);
    }
}
