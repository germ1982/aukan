...
class Usuario_perfil_permisoController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new UsuarioPerfilPermiso",
                ...
                return [
                    ...
                    'title'=> "Create new UsuarioPerfilPermiso",
                    'content'=>'<span class="text-success">Create UsuarioPerfilPermiso success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Updates an existing UsuarioPerfilPermiso model.
     * For ajax request will return json object
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update UsuarioPerfilPermiso #".$id,
