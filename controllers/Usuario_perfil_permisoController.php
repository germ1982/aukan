...
class Usuario_perfil_permisoController extends Controller
{
      ...
      public function actionCreate()
      {
            ...
            if ($request->isAjax) {
                  ...
                  if ($request->isGet) {
                        ...
                        if ($model->save()) {
                              LogPlataforma::registrar(ConstantesGlobales::PERMISOS_DE_PERFIL_DE_USUARIO, ConstantesGlobales::CREACION, $model->idpermiso);
                              return [
                                    'title' => "Nuevo Permiso de Perfil",
      ...
      public function actionUpdate($id)
      {
            ...
            */
                  ...
                  if ($request->isGet) {
                        ...
                        if ($model->save()) {
                              LogPlataforma::registrar(ConstantesGlobales::PERMISOS_DE_PERFIL_DE_USUARIO, ConstantesGlobales::MODIFICACION, $model->idpermiso);
                              return [
                                    'title' => "Nuevo Permiso de Perfil",
                                    'content' => '<span class="text-success">Permiso De Perfil creado Correctamente</span>',
                                    'footer' => Html::button('Cerrar', ['id' => 'btnCerrar', 'class' => 'btn btn-default pull-left', 'data-dismiss' => "modal"]) .
      ...
      public function actionDelete($id)
      {
            ...
            LogPlataforma::registrar(ConstantesGlobales::PERMISOS_DE_PERFIL_DE_USUARIO, ConstantesGlobales::ELIMINACION, $id);
            if ($request->isAjax) {
                  /*
            *   Process for ajax request
            */
