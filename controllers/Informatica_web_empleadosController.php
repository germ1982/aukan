...
class Informatica_web_empleadosController extends Controller
{
    ...
    {   
        ...
        if($request->isAjax){
            ...
            return [
                    'title'=> "InformaticaWebEmpleados #".$id,
    ...
    /**
     * Creates a new InformaticaWebEmpleados model.
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new InformaticaWebEmpleados",
                ...
                return [
                    ...
                    'title'=> "Create new InformaticaWebEmpleados",
                    'content'=>'<span class="text-success">Create InformaticaWebEmpleados success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
            ...
            */
            if ($model->load($request->post()) && $model->save()) {
                return $this->redirect(['view', 'id' => $model->idwebempleado]);
            } else {
    ...
    /**
     * Updates an existing InformaticaWebEmpleados model.
     * For ajax request will return json object
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update InformaticaWebEmpleados #".$id,
    ...
    /**
     * Delete an existing InformaticaWebEmpleados model.
     * For ajax request will return json object
