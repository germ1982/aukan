...
use app\models\StockDepositoEgresoSearch;
...
class Stock_deposito_egresoController extends Controller
{
    ...
    /**
     * Lists all StockDepositoEgreso models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new StockDepositoEgresoSearch();
    ...
    /**
     * Displays a single StockDepositoEgreso model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new StockDepositoEgreso model.
                ...
                if ($guardado && $model->save()) {
                    ...
                    $boton_acta = Html::button(
                        ...
                        [
                            ...
                            'onclick' => "window.open('" . Url::to(['/stock_deposito_egreso/imprimir_acta_entrega', 'idegreso' => $model->idegreso]) . "', '_blank')",
                            'data-toggle' => 'tooltip',
                    ...
                    foreach ($detallesArray as $detalle) {
                        $detalleModel = new StockDepositoEgresoDetalle();
        ...
        if ($request->isAjax) {
            ...
            if ($request->isGet) {
                ...
                if ($guardado && $model->save()) {
                    ...
                    $detallesExistentes = StockDepositoEgresoDetalle::findAll(['idegreso' => $model->idegreso]);
                    ...
                    foreach ($detallesArray as $detalle) {
                        ...
                        $detalleExistente = StockDepositoEgresoDetalle::findOne([
    ...
    /**
     * Delete multiple existing StockDepositoEgreso model.
     * For ajax request will return json object
    ...
    /**
     * Finds the StockDepositoEgreso model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return StockDepositoEgreso the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = StockDepositoEgreso::findOne($id)) !== null) {
            return $model;
        } else {
