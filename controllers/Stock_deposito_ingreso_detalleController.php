...
/**
 * Stock_deposito_ingreso_detalleController implements the CRUD actions for StockDepositoIngresoDetalle model.
 */
class Stock_deposito_ingreso_detalleController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Lists all StockDepositoIngresoDetalle models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new StockDepositoIngresoDetalleSearch();
    ...
    /**
     * Displays a single StockDepositoIngresoDetalle model.
     * @param integer $id
     * @return mixed
     */
    public function actionView($id)
    {
        ...
        if ($request->isAjax) {
            ...
            return [
                'title' => "StockDepositoIngresoDetalle #" . $id,
    ...
    /**
     * Creates a new StockDepositoIngresoDetalle model.
    ...
    {
        $request = Yii::$app->request;
        $model = new StockDepositoIngresoDetalle();
        ...
        if ($request->isAjax) {
            ...
            */
            ...
            if ($request->isGet) {
                return [
                    'title' => "Create new StockDepositoIngresoDetalle",
                ...
                return [
                    ...
                    'title' => "Create new StockDepositoIngresoDetalle",
                    'content' => '<span class="text-success">Create StockDepositoIngresoDetalle success</span>',
                    'footer' => Html::button('Close', ['class' => 'btn btn-default pull-left', 'data-dismiss' => "modal"]) .
    ...
    /**
     * Updates an existing StockDepositoIngresoDetalle model.
     * For ajax request will return json object
    ...
    public function actionUpdate($id)
    {
        ...
        if ($request->isAjax) {
            ...
            */
            ...
            if ($request->isGet) {
                return [
                    'title' => "Update StockDepositoIngresoDetalle #" . $id,
    ...
    /**
     * Delete an existing StockDepositoIngresoDetalle model.
     * For ajax request will return json object
    ...
    /**
     * Delete multiple existing StockDepositoIngresoDetalle model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the StockDepositoIngresoDetalle model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return StockDepositoIngresoDetalle the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = StockDepositoIngresoDetalle::findOne($id)) !== null) {
            return $model;
        } else {
