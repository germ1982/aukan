...
/**
 * This is the model class for table "stock_deposito_egreso".
 *
 ...
 */
class StockDepositoEgreso extends \yii\db\ActiveRecord
{
    public $fdesde;
    public $fhasta;
    ...
    public function attributeLabels()
    {
        ...
        /* Esto indica que cada registro en StockDepositoEgreso tiene muchos StockDepositoEgresoDetalle. */
        public function getDetalles()
        {
            return $this->hasMany(StockDepositoEgresoDetalle::class, ['idstock_deposito_Egreso' => 'id']);
        }
}
