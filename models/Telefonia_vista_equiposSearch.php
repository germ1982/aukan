...
use app\models\Telefonia_vista_equipos;

/**
 * Telefonia_vista_equiposSearch represents the model behind the search form about `app\models\Telefonia_vista_equipos`.
 */
class Telefonia_vista_equiposSearch extends Telefonia_vista_equipos
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['ultimo_movimiento', 'modelo', 'dispositivo', 'imei', 'fdesde', 'fhasta'], 'safe'],
        ];
    }
    ...
    {
        $query = Telefonia_vista_equipos::find();
