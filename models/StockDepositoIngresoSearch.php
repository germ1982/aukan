...
/**
 * StockDepositoIngresoSearch represents the model behind the search form about `app\models\StockDepositoIngreso`.
 */
class StockDepositoIngresoSearch extends StockDepositoIngreso
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = StockDepositoIngreso::find();
        ...
        $query->leftJoin('empleado e', 'stock_deposito_ingreso.idempleado_recepcion = e.idempleado');
